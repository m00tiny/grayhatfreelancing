+++
title = "Microsoft Window's Data Protection API"
date = '2022-11-03'
description = 'Methods for extracting Windows credentials from DPAPI AKA Microsoft Windows Data Protection API'
+++
# Windows - DPAPI
